...
<head>
    ...
    <meta charset="utf-8">
    <meta http-equiv="X<!DOCTYPE html>
<html lang="en">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Local Brand</div>
            </a>
            <!-- Divider -->
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('user/ventela') ?>">
                    <i class="fas fa-fw fa-food"></i>
                    <span>Ventela</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('user/jhonson') ?>">
                    <i class="fas fa-fw fa-bottle"></i>
                    <span>Jhonson</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('user/brodo') ?>">
                    <i class="fas fa-fw fa-bottle"></i>
                    <span>Brodo</span></a>
            </li>
            <hr class="sidebar-divider">
...
</html>-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="">
    <meta name="author" content="">
